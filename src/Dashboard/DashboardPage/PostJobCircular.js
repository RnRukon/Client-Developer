...
import { usePostCircularMutation } from '../../Redux/Features/Circular/CircularApi';

const PostJobCircular = () => {

    const { register, handleSubmit, setValue, formState: { errors } } = useForm();

    const [postCircular, { isSuccess, isError }] = usePostCircularMutation();
    ...
    useEffect(() => {
        ...
        if (isError) {
            alert('something id wrong, please try ageing')
        }
    }, [isSuccess, isError])
    return (
        <div className=' pt-28'>
...
export default PostJobCircular;